...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- Text Input for External Doc Reference -->
    <div>
        <label for="external_doc_reference">External Doc Reference:</label>
        <input type="text" name="external_doc_reference" required>
    </div>
